...
function Get-SoftwareList {
    return @(
        ...
        [PSCustomObject]@{ Nome = "Fishstrap (Roblox)"; Id = "Fishstrap.Fishstrap";     Categoria = (Get-Text "CatGames"); Descricao = (Get-Text "DescFishstrap") },
        ...
        [PSCustomObject]@{ Nome = "YARG (Rhythm Game)"; Id = "YARC.YARCLauncher";       Categoria = (Get-Text "CatGames"); Descricao = (Get-Text "DescYARG") },
        ...
        [PSCustomObject]@{ Nome = "FileZilla FTP";      Id = "FileZilla.FileZilla";     Categoria = (Get-Text "CatDevelopment"); Descricao = (Get-Text "DescFileZilla") },
        [PSCustomObject]@{ Nome = "Git";                Id = "Git.Git";                 Categoria = (Get-Text "CatDevelopment"); Descricao = (Get-Text "DescGit") },
        [PSCustomObject]@{ Nome = "Java 17 (JDK)";      Id = "EclipseAdoptium.Temurin.17.JDK"; Categoria = (Get-Text "CatDevelopment"); Descricao = (Get-Text "DescJava17") },
        [PSCustomObject]@{ Nome = "Java 21 (JDK)";      Id = "EclipseAdoptium.Temurin.21.JDK"; Categoria = (Get-Text "CatDevelopment"); Descricao = (Get-Text "DescJava21") },
        ...
        [PSCustomObject]@{ Nome = "Visual C++ Redist";  Id = "TechPowerUp.VCRedist";    Categoria = (Get-Text "CatDevelopment"); Descricao = (Get-Text "DescVCRedist") },
        ...
        [PSCustomObject]@{ Nome = "Open-Shell Menu";    Id = "Open-Shell.Open-Shell-Menu"; Categoria = (Get-Text "CatSystem"); Descricao = (Get-Text "DescOpenShell") },
