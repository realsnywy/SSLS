<#
    SSLS - Installer (Instalação Permanente)
    Instala em C:\SSLS, configura atalho na Desktop e executa.
    Uso: irm https://raw.githubusercontent.com/realsnywy/SSLS/main/Install.ps1 | iex
#>
...
if (-not $currentPrincipal.IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    ...
    $SelfURL = "https://raw.githubusercontent.com/realsnywy/SSLS/main/Install.ps1"
...
Write-Host " [5/5] Iniciando SSLS..." -ForegroundColor Green
